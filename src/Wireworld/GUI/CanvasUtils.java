...
public class CanvasUtils {
    public synchronized static void printGrid(Grid grid, double cellSize, GraphicsContext gc) {
    ...
    public synchronized static void printCell(int row, int column, double size, GraphicsContext gc, AbstractCell cell) {
